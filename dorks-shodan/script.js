                ...
                if (data.hasOwnProperty(optionKey)) {
                    ...
                    for (const dorkKey in option) {
                        if (option.hasOwnProperty(dorkKey)) {
                            ...
                            const link = `https://shodan.io/search?query=${(modifiedDorkName)}`;
...
document.addEventListener('DOMContentLoaded', function () {
    setInterval(function () {
        ...
        if (currentText === 'Dorks shodan') {
            changingTextElement.innerHTML = 'Free Palestine <i class="icon"><img src="Free-Palestine.png" alt="Free Palestine"></i>';
        } else {
            changingTextElement.innerHTML = 'Dorks shodan <i class="icon"><img src="Free-Palestine-2.png" alt="Free Palestine"></i>';
        }
    }, 4000);
});
updateSelectOptions();
