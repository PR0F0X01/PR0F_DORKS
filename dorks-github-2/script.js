                ...
                if (data.hasOwnProperty(optionKey)) {
                    ...
                    for (const dorkKey in option) {
                        if (option.hasOwnProperty(dorkKey)) {
                            ...
                            const link = `https://gist.github.com/search?q=${(modifiedDorkName)}&type=code`;
...
document.addEventListener('DOMContentLoaded', function () {
    setInterval(function () {
        ...
        if (currentText === 'Dorks github 2') {
            changingTextElement.innerHTML = 'Free Palestine <i class="icon"><img src="Free-Palestine.png" alt="Free Palestine"></i>';
        } else {
            changingTextElement.innerHTML = 'Dorks github 2 <i class="icon"><img src="Free-Palestine-2.png" alt="Free Palestine"></i>';
        }
    }, 4000);
});
updateSelectOptions();
